...
export class PersonParticipantFormComponent extends AbstractEntityFormComponent<PersonParticipantEntity> {
  ...
  protected override onInit(): void {
    ...
    this.subscribeOnce(
      this.paymentTypeService.listPaymentTypes(),
      (paymentTypes: PaymentTypeListItem[]): void => {
  ...
  protected override getForm(): FormGroup {
    return new FormGroup({
      ...
      nationalIdentificationCode: new FormControl(
        undefined,
        Validators.required,
      ),
  ...
  protected override onSubmit(
    personParticipantEntity: PersonParticipantEntity,
  ): void {
    if (personParticipantEntity.id) {
      this.subscribeOnce(
        this.personParticipantService.modifyPersonParticipant(
          personParticipantEntity.id,
      ...
      this.subscribeOnce(
        this.eventService.addPersonParticipant(
          this.eventId,
          personParticipantEntity,
        ),
        (): void => {
