...
export class LegalEntityParticipantFormComponent extends AbstractEntityFormComponent<LegalEntityParticipantEntity> {
  ...
  protected override onSubmit(
    legalEntityParticipantEntity: LegalEntityParticipantEntity,
  ): void {
    if (legalEntityParticipantEntity.id) {
      this.subscribeOnce(
        this.legalEntityParticipantService.modifyLegalEntityParticipant(
          legalEntityParticipantEntity.id,
      ...
      this.subscribeOnce(
        this.eventService.addLegalEntityParticipant(
          this.eventId,
          legalEntityParticipantEntity,
        ),
        (): void => {
