...
export class LegalEntityParticipantComponent
  ...
  implements OnInit
{
  ...
  public ngOnInit(): void {
    ...
    const legalEntityParticipantId: number =
      this.activatedRoute.snapshot.params['id'];
    this.subscribeOnce(
      this.legalEntityParticipantService.getLegalEntityParticipant(
      ...
      (legalEntityParticipant: LegalEntityParticipant): void => {
        ...
        this.formComponent
          .getEntitySubject()
          .next(legalEntityParticipantEntity);
      },
    );
  }
}
