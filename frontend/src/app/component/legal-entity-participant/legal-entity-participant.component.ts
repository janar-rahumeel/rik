...
@Component({
  selector: 'legal-entity-participant',
...
export class LegalEntityParticipantComponent extends AbstractComponent implements OnInit {
  ...
  public ngOnInit(): void {
    ...
    let legalEntityParticipantId: number = this.activatedRoute.snapshot.params['id'];
    this.subscribeOnce(this.legalEntityParticipantService.getLegalEntityParticipant(legalEntityParticipantId), (legalEntityParticipant: LegalEntityParticipant): void => {
      let legalEntityParticipantEntity: LegalEntityParticipantEntity = {id: legalEntityParticipantId, ...legalEntityParticipant};
